...
createdb contours2 -O tirex -D fastspace
...
osm2pgsql --slim --drop --flat-nodes=/mnt/1tb/tablespace/con-nodes.dat -d contours2 --cache 5000 --style /home/otm/db/contours.style /mnt/sql-dump/contoursmixed.osm.pbf
psql -d contours2 -c 'GRANT SELECT ON ALL TABLES IN SCHEMA public TO tirex;'
